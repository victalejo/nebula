...
const DeploymentLogsModal: Component<DeploymentLogsModalProps> = (props) => {
  ...
  const connect = () => {
    ...
    eventSource = api.streamDeploymentLogs(props.appName, props.deploymentId, { follow: true, tail: 100 });
    ...
    <div class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div class="bg-white rounded-lg shadow-xl w-full max-w-4xl max-h-[90vh] flex flex-col">
        ...
        <div class="flex items-center justify-between p-4 border-b">
          <div>
            <h2 class="text-lg font-semibold text-gray-900">Logs del Despliegue</h2>
            <p class="text-sm text-gray-500">Version: {props.deploymentVersion}</p>
          </div>
          <button
        ...
        <div class="flex items-center justify-between p-3 border-b bg-gray-50">
          <div class="flex items-center space-x-3">
            ...
            <span class="text-sm text-gray-600">{logs().length} lineas</span>
          </div>
        ...
        <div
          ref={logContainer}
          class="bg-gray-900 p-4 flex-1 overflow-y-auto font-mono text-sm min-h-[400px]"
        >
